...
class ResNet50(nn.Module):
    ...
    def _load_pretrained(self, training_method: str) -> None:
        ...
        if training_method == "mocov2":
            state_dict = torch.load("/home/tayyab/Documents/new/moco_v2_200ep_pretrain.pth.tar")["state_dict"]
            ...
            state_dict = torch.load("/home/tayyab/Documents/new/swav_800ep_pretrain.pth.tar")
            for k in list(state_dict.keys()):
